...
In earlier iterations, I tried simple `for` loops with end conditions. It was messy, hard to extend, and difficult to reason about. **Then I discovered FSM (Finite State Machine)**, and everything changed. 🚀
