...
- **181 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `github.com/nquangtrung/agentgo`, `MessageContent`, `ContextKey` (+176 more)
...
- **What connects `$schema`, `.opencode/plugins/graphify.js`, `github.com/nquangtrung/agentgo` to the rest of the system?**
